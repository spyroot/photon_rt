...
function main() {
  ...
  xargs -I {} cp -u $DEFAULT_RPM_DST_DIR/{}*.rpm $rpm_dir)
#  cp -u "$additional_rpms" "$rpm_dir"
  ...
  xargs -I {} cp -u $DEFAULT_RPM_DST_DIR/{}*.noarch.rpm $noarch)
  #  cp -u "$additional_noarch_rpms" "$noarch"
